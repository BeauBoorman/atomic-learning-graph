...
1. [[id:choose-a-goal][Choose a goal]] — Begin with something specific that you want to understand.

2. [[id:follow-the-path][Follow the path]] — Learn prerequisites before the ideas that depend on them.

3. [[id:learn-one-idea][Learn one idea]] — Each stop explains one concept in plain language.

4. [[id:check-the-receipt][Check the receipt]] — Every explanation stays close to the source passage that supports it.

5. [[id:take-it-with-you][Take it with you]] — Use the learning tool you already like.
...
README.md — The whole project, steps 1 and 2

** Keep moving

[[id:alg-showcase][← Start Here]] · [[id:follow-the-path][Follow the path →]]
...
src/graph/path.ts — deterministic prerequisite walk

** Keep moving

[[id:choose-a-goal][← Choose a goal]] · [[id:learn-one-idea][Learn one idea →]]
...
README.md — Atomic steps and prerequisite scaffolding

** Keep moving

[[id:follow-the-path][← Follow the path]] · [[id:check-the-receipt][Check the receipt →]]
...
src/graph/invariants.ts — quote-primary provenance checks

** Keep moving

[[id:learn-one-idea][← Learn one idea]] · [[id:take-it-with-you][Take it with you →]]
...
README.md — What ships beyond the reader

** Keep moving

[[id:check-the-receipt][← Check the receipt]] · [[id:alg-showcase][Finish →]]
