...
- Extracted text SHA-256: `51cde09535ee72127cdcf7b0e22d214cdc6774787882ec75eb53eda1d2679a77`
- Modifications made: Extracted from the pinned Markdown: fenced code blocks, tables, emphasis delimiters, and inline role directives (:numref:, :eqref:, :cite:) were removed; inline and display LaTeX were preserved verbatim; links and reference anchors were resolved to plain text; whitespace outside preserved LaTeX was collapsed. Section headings and tab directives (:begin_tab: / :end_tab:) are retained inline.
...
- Extracted text SHA-256: `f75262bf3b2fc7e292eabaad7b5b3a9389a90c4e562b26d4e2531d3740df08f5`
- Modifications made: Extracted from the pinned Markdown: fenced code blocks, tables, emphasis delimiters, and inline role directives (:numref:, :eqref:, :cite:) were removed; inline and display LaTeX were preserved verbatim; links and reference anchors were resolved to plain text; whitespace outside preserved LaTeX was collapsed. Section headings and tab directives (:begin_tab: / :end_tab:) are retained inline.
...
- Extracted text SHA-256: `5e4a75161975473f36b406f3b10a9eecde1c8da4e3038495e41ac739794dff9b`
- Modifications made: Extracted from the pinned Markdown: fenced code blocks, tables, emphasis delimiters, and inline role directives (:numref:, :eqref:, :cite:) were removed; inline and display LaTeX were preserved verbatim; links and reference anchors were resolved to plain text; whitespace outside preserved LaTeX was collapsed. Section headings and tab directives (:begin_tab: / :end_tab:) are retained inline.
...
- Extracted text SHA-256: `6a5df9be5df4682860fcf95f28852b7662d0faed3e7b5f0b766de80f8853d120`
- Modifications made: Extracted from the pinned Markdown: fenced code blocks, tables, emphasis delimiters, and inline role directives (:numref:, :eqref:, :cite:) were removed; inline and display LaTeX were preserved verbatim; links and reference anchors were resolved to plain text; whitespace outside preserved LaTeX was collapsed. Section headings and tab directives (:begin_tab: / :end_tab:) are retained inline.
